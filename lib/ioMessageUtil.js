...
exports.ioMessage = function(opts) {
    if(opts) {
        return {
            ...
            contextdata: initStringValue(opts.contextdata),
            contentdata: initStringValue(opts.contentdata)
        };
    } else {
        return {
            id: '',
...
exports.toJSON = function(ioMsg, encode) {
    ...
    return {
        ...
        version: IO_MESSAGE_VERSION,
        timestamp: initNumberValue(ioMsg.timestamp),
        ...
        contextdata: initStringValue(contextdata),
        contentdata: initStringValue(contentdata)
    };
};
